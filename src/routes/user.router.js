...
// referencias
userRouter.get("/formularios/referencias/add/:id", authRoutes, formulario.addReferenciasPage);
// smss
...
userRouter.get("/formularios/smss/edit/:idfra/:idsms", authRoutes, formulario.smssEditPage);
