/*! formularios 2023-06-18 */
const getCookie=i=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(t=e.split("=")[1])}),t},setCookie=(e,i,t)=>{let l="";var n;t&&((n=new Date).setTime(n.getTime()+24*t*60*60*1e3),l="; expires="+n.toUTCString()),document.cookie=e+"="+(i||"")+l+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(l=>{l.addEventListener("click",()=>{var e=l.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(l.parentElement.children,l),t=l.classList.contains("th-sort-asc");sortTableByColumn(e,i,!t)})}),(e,t,i=!0)=>{const l=i?1:-1;var n,s=e.tBodies[0];for(n of Array.from(s.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[t].textContent;return i.cells[t].textContent<e?l:-1*l}))s.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const l=document.getElementById("table-body");l.innerHTML="",e.map(e=>{var i=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFOR===estados.pendiente?t.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-red-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`:e.STAFOR===estados.asignado?t.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-blue-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`:e.STAFOR===estados.resuelto&&(t.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-green-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`),i.appendChild(t),(t=document.createElement("td")).classList.add("w-8"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.DESOFI}</div>
      </div>
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.EJEFOR}</div>
      </div>
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-6"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.REFFOR}</div>
      </div>
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-7"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NIFCON}</div>
      </div>
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-25"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NOMCON}</div>
      </div>
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-15"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,i.appendChild(t),t=document.createElement("td"),null!==e.OBSFOR&&(t.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${37<e.OBSFOR.length?e.OBSFOR.slice(0,37)+"...":e.OBSFOR}</div>
        </div>
      </div>`),i.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),e.STAFOR===estados.pendiente?t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          ...
          <ul>
            <li class="nav-item">
              <a href="/admin/formularios/edit/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idasig').value ='${e.IDFORM}', document.getElementById('msgasi').innerHTML ='<p>Ejercicio ${e.EJEFOR}</p><p>${e.NIFCON} ${e.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-asignar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idborr').value ='${e.IDFORM}', document.getElementById('msgbor').innerHTML ='<p>Ejercicio ${e.EJEFOR}</p><p>${e.NIFCON} ${e.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-borrar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      </ul>`:e.STAFOR===estados.resuelto?t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
          ...
          <ul>
            <li class="nav-item ">
              <a href="/admin/formularios/relaciones/readonly/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item ">
              <a href="/user/formularios/smss/readonly/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      </ul>`:t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idcerr').value ='${e.IDFORM}', document.getElementById('msgcer').innerHTML ='<p>Ejercicio ${e.EJEFOR}</p><p>${e.NIFCON} ${e.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-resolver">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('iddesa').value ='${e.IDFORM}', document.getElementById('msgdes').innerHTML ='<p>Ejercicio ${e.EJEFOR}</p><p>${e.NIFCON} ${e.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-desasignar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="/admin/formularios/referencias/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item list-divider"></li>
            <li class="nav-item ">
              <a href="/admin/formularios/smss/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M12.875 10.4V5.1q0-.275.2-.488.2-.212.475-.212h5.3q.275 0 .487.212.213.213.213.488v3.1q0 .25-.213.462-.212.213-.487.213h-4.425Zm.65-2.175H18.9V5.05h-5.375Zm0 0V5.05v3.175Zm4.975 11.2q-2.375 0-4.863-1.287-2.487-1.288-4.524-3.326-2.038-2.037-3.338-4.512-1.3-2.475-1.3-4.85 0-.45.288-.75.287-.3.737-.3h1.925q.45 0 .75.262.3.263.4.688l.45 2q.075.375-.013.7-.087.325-.362.55L6.6 10.475q1.4 2.35 3.1 4.037 1.7 1.688 4.075 3.013l2.05-2.15q.275-.275.525-.35.25-.075.575 0l1.65.325q.45.1.713.412.262.313.262.763v1.85q0 .45-.3.75t-.75.3ZM6.275 9.9l2-1.8q.1-.1.138-.275.037-.175.012-.325L7.95 5.45q-.05-.2-.175-.3-.125-.1-.325-.1H5.475q-.175 0-.262.1-.088.1-.088.25-.025 1 .288 2.162.312 1.163.862 2.338Zm8.1 7.875q1 .525 2.187.763 1.188.237 1.988.237.15 0 .25-.1t.1-.25v-1.95q0-.2-.1-.325t-.3-.175l-1.675-.35q-.15-.05-.263-.012-.112.037-.237.162ZM6.275 9.9Zm8.1 7.875Z"/>
                </svg>
                Gestión SMS
      ...
      </ul>`,i.appendChild(t),l.appendChild(i)}),createPages()},createPages=()=>{let e="<ul>";hasPrevs?e+="<li class='page-item previous no'><a href='/admin/formularios?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFormBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNexts?e+="<li class='page-item next no'><a href='/admin/formularios?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFormBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFormBox"),elemDel=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("del")),elemDesag=(elemDel.setAttribute("action","/admin/formularios/delete?part="+getCookie("filtro")),document.getElementById("desag")),elemAsig=(elemDesag.setAttribute("action","/admin/formularios/desasignar?part="+getCookie("filtro")),document.getElementById("asig")),elemCerr=(elemAsig.setAttribute("action","/admin/formularios/asignar?part="+getCookie("filtro")),document.getElementById("cerr")),elemRes=(elemCerr.setAttribute("action","/admin/formularios/resolver?part="+getCookie("filtro")),document.getElementById("rsltos"));elemRes.setAttribute("href","/admin/formularios/resueltos?part="+getCookie("filtro")),buildTable(orgList);