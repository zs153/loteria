/*! formularios 2023-06-17 */
const getCookie=i=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(l=e.split("=")[1])}),l},setCookie=(e,i,l)=>{let t="";var n;l&&((n=new Date).setTime(n.getTime()+24*l*60*60*1e3),t="; expires="+n.toUTCString()),document.cookie=e+"="+(i||"")+t+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(t=>{t.addEventListener("click",()=>{var e=t.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(t.parentElement.children,t),l=t.classList.contains("th-sort-asc");sortTableByColumn(e,i,!l)})}),(e,l,i=!0)=>{const t=i?1:-1;var n,s=e.tBodies[0];for(n of Array.from(s.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[l].textContent;return i.cells[l].textContent<e?t:-1*t}))s.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const t=document.getElementById("table-body");t.innerHTML="",e.map(e=>{var i=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-4"),e.STAFOR===estados.pendiente?l.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-red-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`:e.STAFOR===estados.asignado?l.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-blue-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`:e.STAFOR===estados.resuelto&&(l.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-green-lt">
          <h6>${e.LIQFOR}</h6>
        </span>
      </div>`),i.appendChild(l),(l=document.createElement("td")).classList.add("w-8"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.DESOFI}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-5"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.EJEFOR}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-6"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.REFFOR}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-7"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NIFCON}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-25"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NOMCON}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-15"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,i.appendChild(l),l=document.createElement("td"),null!==e.OBSFOR&&(l.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${37<e.OBSFOR.length?e.OBSFOR.slice(0,37)+"...":e.OBSFOR}</div>
        </div>
      </div>`),i.appendChild(l),(l=document.createElement("td")).classList.add("w-5"),e.STAFOR===estados.pendiente?l.innerHTML=`<ul class="dots-menu">
      ...
      </ul>`:e.STAFOR===estados.resuelto?l.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
      ...
      </ul>`:l.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
          ...
          <ul>
            ...
            <li class="nav-item">
            <a href="/admin/formularios/resolver/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="/admin/formularios/referencias/add/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
