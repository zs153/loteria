...
const getCookie=l=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(l)&&(t=e.split("=")[1])}),t},setCookie=(e,l,t)=>{let i="";var s;t&&((s=new Date).setTime(s.getTime()+24*t*60*60*1e3),i="; expires="+s.toUTCString()),document.cookie=e+"="+(l||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,l=Array.prototype.indexOf.call(i.parentElement.children,i),t=i.classList.contains("th-sort-asc");sortTableByColumn(e,l,!t)})}),(e,t,l=!0)=>{const i=l?1:-1;var s,n=e.tBodies[0];for(s of Array.from(n.querySelectorAll("tr")).sort((e,l)=>{e=e.cells[t].textContent;return l.cells[t].textContent<e?i:-1*i}))n.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",l),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!l)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var l=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFOR===estados.pendiente?t.innerHTML=`<div class="align-items-center py-1">
      ...
      </div>`),l.appendChild(t),(t=document.createElement("td")).classList.add("w-8"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.DESOFI}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.EJEFOR}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-6"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.REFFOR}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-7"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NIFCON}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-25"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NOMCON}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-15"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,l.appendChild(t),t=document.createElement("td"),null!==e.OBSFOR&&(t.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${66<e.OBSFOR.length?e.OBSFOR.slice(0,66)+"...":e.OBSFOR}</div>
        </div>
      </div>`),l.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),e.STAFOR===estados.pendiente?t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          ...
          <ul>
            <li class="nav-item">
              <a href="/user/formularios/edit/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <li class="nav-item drop-right">
          ...
          <ul>
            <li class="nav-item">
              <a href="/user/formularios/readonly/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M6.85 20.575q-.6 0-1.012-.412-.413-.413-.413-1.013V4.85q0-.6.413-1.013.412-.412 1.012-.412h7.825L18.6 7.35v3.4h-.65V7.675h-3.6V4.05h-7.5q-.3 0-.55.25-.25.25-.25.55v14.275q0 .3.25.55.25.25.55.25h4.25v.65Zm-.8-.65V4.05 19.925ZM17.025 14.6l.45.425-3.75 3.75v1.1h1.1l3.775-3.75.45.45-3.95 3.95h-2v-2Zm2.025 1.975L17.025 14.6l1.05-1.05q.225-.2.525-.2.3 0 .475.2l1 1q.2.2.2.487 0 .288-.2.538Z"/></svg>
                </svg>
                Formulario
            ...
            <li class="nav-item">
              <a href="/user/formularios/referencias/readonly/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <li class="nav-item drop-right">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="/user/formularios/resolver/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="/user/formularios/referencias/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item list-divider"></li>
            <li class="nav-item ">
              <a href="/user/formularios/smss/${e.IDFORM}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M12.875 10.4V5.1q0-.275.2-.488.2-.212.475-.212h5.3q.275 0 .487.212.213.213.213.488v3.1q0 .25-.213.462-.212.213-.487.213h-4.425Zm.65-2.175H18.9V5.05h-5.375Zm0 0V5.05v3.175Zm4.975 11.2q-2.375 0-4.863-1.287-2.487-1.288-4.524-3.326-2.038-2.037-3.338-4.512-1.3-2.475-1.3-4.85 0-.45.288-.75.287-.3.737-.3h1.925q.45 0 .75.262.3.263.4.688l.45 2q.075.375-.013.7-.087.325-.362.55L6.6 10.475q1.4 2.35 3.1 4.037 1.7 1.688 4.075 3.013l2.05-2.15q.275-.275.525-.35.25-.075.575 0l1.65.325q.45.1.713.412.262.313.262.763v1.85q0 .45-.3.75t-.75.3ZM6.275 9.9l2-1.8q.1-.1.138-.275.037-.175.012-.325L7.95 5.45q-.05-.2-.175-.3-.125-.1-.325-.1H5.475q-.175 0-.262.1-.088.1-.088.25-.025 1 .288 2.162.312 1.163.862 2.338Zm8.1 7.875q1 .525 2.187.763 1.188.237 1.988.237.15 0 .25-.1t.1-.25v-1.95q0-.2-.1-.325t-.3-.175l-1.675-.35q-.15-.05-.263-.012-.112.037-.237.162ZM6.275 9.9Zm8.1 7.875Z"/>
                </svg>
                Mensajes
      ...
      </ul>`,l.appendChild(t),i.appendChild(l)}),createPages()},createPages=()=>{let e="<ul>";hasPrevs?e+="<li class='page-item previous no'><a href='/user/formularios?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFormBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNexts?e+="<li class='page-item next no'><a href='/user/formularios?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFormBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFormBox"),elemNew=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("new")),elemDel=(elemNew.setAttribute("href","/user/formularios/add?part="+getCookie("filtro")),document.getElementById("del")),elemDesag=(elemDel.setAttribute("action","/user/formularios/delete?part="+getCookie("filtro")),document.getElementById("desag")),elemAsig=(elemDesag.setAttribute("action","/user/formularios/desasignar?part="+getCookie("filtro")),document.getElementById("asig")),elemCerr=(elemAsig.setAttribute("action","/user/formularios/asignar?part="+getCookie("filtro")),document.getElementById("cerr")),elemRes=(elemCerr.setAttribute("action","/user/formularios/resolver?part="+getCookie("filtro")),document.getElementById("rsltos"));elemRes.setAttribute("href","/user/formularios/resueltos?part="+getCookie("filtro")),buildTable(orgList);