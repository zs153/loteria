...
const arrayFilter = (value, formulario, estados) => {
  ...
  buildTable(state, formulario, estados)
}
...
const buildTable = (state, formulario, estados) => {
  ...
  myList.map(element => {
    ...
    cell.innerHTML = `<ul class="dots-menu">
      <li class="nav-item drop-right">
        ...
        <ul>
          <li class="nav-item">
            <a href="/admin/formularios/smss/edit/${formulario.IDDOCU}/${element.IDSMSS}" class="nav-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
const onclickPage = (pages, page) => {
  ...
  state.page = page
  buildTable(state, formulario, estadosSms)
}